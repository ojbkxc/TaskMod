...
fn default_mqtt_broker() -> String { "tcp://localhost:1883".to_string() }
fn default_mqtt_topic_prefix() -> String { "taskmod".to_string() }
fn default_mqtt_client_id() -> String { "taskmod-device".to_string() }