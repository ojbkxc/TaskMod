...
- **侧边栏导航** - 仪表盘 | AI助手 | 设备 | 知识库 | 任务 | 脚本 | 文件 | TTS | 配置 | 日志
- **深色/浅色主题** - 支持一键切换
...
- **文件管理** - 浏览设备文件、新建/删除/重命名/复制/粘贴、上传/下载、zip压缩/解压、权限修改、在线编辑文本文件
- **截图管理** - 拍摄、预览、删除截图
- **日志查看** - 实时查看执行日志
- **命令执行** - 执行任意 shell 命令
- **配置管理** - 在线编辑配置文件
...
- **文件管理器** - 参照 MaterialFiles，全新文件管理功能：面包屑导航、文件列表/网格视图、搜索过滤、排序、新建/删除/重命名/复制/粘贴、上传/下载、zip压缩/解压、权限修改、在线编辑文本文件、图片查看器(缩放拖拽)、30+种文件类型图标
- **WebSocket 自动重连** - 参照 Scarlet 项目，AI对话/投屏/音频全部支持指数退避+随机抖动自动重连
